...
import AwardTable from "../pages/AwardTable"
import AwardPic from "../pages/AwardPic"
  ...
  <div>
    <div className='d-flex align-items-center justify-content-center' >
      <div >
        ...
        {/* <div className='mt-3'>
          <Link to="/winnerdetails"><Button variant="outline-dark">View Winner Details</Button></Link>
        </div> */}
      </div>
    </div>
    <div>
